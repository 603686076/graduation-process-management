 ...
 */
@RestController
@RequestMapping("/viewsuggestions")
public class ViewTeacherSuggestionsController extends BaseController {
    @Autowired
     ...
     * 查询所有任务列表
     */
    @PreAuthorize(hasPermi = "graduation:viewsuggestions:list")
    @GetMapping("/list")
